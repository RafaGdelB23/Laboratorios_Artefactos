...
#define AIO_USERNAME "crisfernan"
...
void loop()
{
  ...
  double ldrStatus = analogRead(ldrPin);
  double convertStatus =  (ldrStatus/1023.0)*5.0;
  Serial.print("Voltaje LDR: ");
  Serial.println(convertStatus);
  if (!temperature.publish(convertStatus))
  {
